  ...
  var values = jsonform.getFormValue(this.domRoot);
        ...
        if (options.validate !== false) {
            ...
            if (schemaVersion == undefined) {
                console.log("schema Version undefined. Default schema version is draft-07");
                ajv = new ajv7.default({strict: false, allErrors: true});
                ...
                console.log("schema Version unknown. Default schema version is draft-07");
                ajv = new ajv7.default({strict: false, allErrors: true});
            }
            ...
            try {
                ...
                console.log(e);
                var error = {"instancePath":"/", "message":"Schema invalid"};
                if (!errors) {
                  errors = [];
                }
