...
showModal = (type, message, link) => {
    ...
    if (type === modalType.ALERT) {
        ...
        $(modelId + " .btn").on('click', function(){ window.location.href = link; });
 ...
 * @param {type} options
 * @param {type} readOperation
 * @param {type} updateOperation
 * @param {type} deleteOperation
 * @param {type} createOperation
 ...
 */
$.fn.metadataeditorTable = function (options, readOperation, updateOperation, deleteOperation, createOperation) {
    var renderElt = this;
    var editor = new editorDefinitionTable();
    editor.initializeInputsTable(options, renderElt);
    editor.generateTable(readOperation, updateOperation, deleteOperation, createOperation);
    return editor;
};
/**
...
editorDefinitionTable.prototype.initializeInputsTable = function (options, renderElt) {
    ...
    this.uiForm = options.uiForm || _throw("JSON UI Form is missing");
 ...
 * @returns {undefined}
 */
editorDefinitionTable.prototype.generateTable = function (readOperation, updateOperation, deleteOperation, createOperation) {

    if (this.read) {
        this.items.push({formatter: iconEye, hozAlign: "right", width: 60, headerSort: false, cellClick: function (e, cell) {
                emptyElt(formElt);
                readOperation(cell.getRow().getData());
            }});
    }
    ...
    if (this.edit) {
        this.items.push({formatter: iconEdit, hozAlign: "right", width: 60, headerSort: false, cellClick: function (e, cell) {
                emptyElt(formElt);
                updateOperation(cell.getRow().getData());
            }});
    }
    ...
    if (this.delete) {
        this.items.push({formatter: iconTrash, hozAlign: "right", width: 60, headerSort: false, cellClick: function (e, cell) {
                emptyElt(formElt);
                deleteOperation(cell.getRow().getData());
            }});
    }
